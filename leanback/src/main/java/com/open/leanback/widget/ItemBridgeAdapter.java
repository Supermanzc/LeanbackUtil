...
public class ItemBridgeAdapter extends RecyclerView.Adapter implements FacetProviderAdapter {
    ...
    private RecyclerView.RecycledViewPool mViewPool = new RecyclerView.RecycledViewPool(); // 优化垂直滚动
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        // 优化垂直滚动
        if (presenterVh instanceof ListRowPresenter.ViewHolder) {
            ((ListRowPresenter.ViewHolder)presenterVh).getGridView().setRecycledViewPool(mViewPool);
        }
        //
