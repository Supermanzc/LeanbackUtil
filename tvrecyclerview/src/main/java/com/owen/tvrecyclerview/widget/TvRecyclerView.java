...
public class TvRecyclerView extends RecyclerView implements View.OnClickListener, View.OnFocusChangeListener{
    ...
    public void onClick(View itemView) {
        if(null != mOnItemListener && this != itemView) {
            mLastClickPosition = getChildAdapterPosition(itemView);
...
//        }
        ...
        if (null != itemView && itemView != this) {
            ...
            if (hasFocus) {
                ...
                if (null != mOnItemListener)
                    mOnItemListener.onItemSelected(TvRecyclerView.this, itemView, position, hasFocus);
            } else {
                ...
                if (null != mOnItemListener) {
                    if (position == -1) {
                        position = (mSelectedPosition - 1 < 0 ? 0 : mSelectedPosition - 1);
                    }
                    mOnItemListener.onItemPreSelected(TvRecyclerView.this, itemView, position, hasFocus);
                }
            }
        }
    }
    ...
    public interface OnItemListener {
        void onItemPreSelected(TvRecyclerView parent, View itemView, int position, boolean hasFocus);

        void onItemSelected(TvRecyclerView parent, View itemView, int position, boolean hasFocus);
