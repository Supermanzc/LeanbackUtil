...
public class RowsFragment extends BaseRowFragment {
    ...
    public void setOnItemViewSelectedListener(OnItemViewSelectedListener listener) {
        ...
        if (listView != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                ViewHolder vh = rowPresenter.getRowViewHolder(ibvh.getViewHolder());
    ...
    private final ItemBridgeAdapter.AdapterListener mBridgeAdapterListener =
        ...
        public void onAttachedToWindow(ItemBridgeAdapter.ViewHolder vh) {
            ...
            ViewHolder rowVh = rowPresenter.getRowViewHolder(vh.getViewHolder());
    ...
    private void setupSharedViewPool(ItemBridgeAdapter.ViewHolder bridgeVh) {
        ...
        ViewHolder rowVh = rowPresenter.getRowViewHolder(bridgeVh.getViewHolder());
