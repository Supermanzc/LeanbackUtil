 ...
 * 播放引擎控制模块
 */
public class PlayVlcEngine implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    private static final String TAG = PlayVlcEngine.class.getName();
