...
public final class GridLayoutManager extends RecyclerView.LayoutManager {
     ...
     * TO:  This is somewhat duplication of RecyclerView getOldPosition() which is
...
//        if (TRACE) TraceHelper.endSection();
    ...
    private void forceRequestLayout() {
        ...
        // TO: investigate allowing a second layout pass,
...
//        if (TRACE) TraceHelper.endSection();
    ...
    private Grid.Provider mGridProvider = new Grid.Provider() {
        ...
        public int getCount() {
            // !!! BUG, 非空崩溃.
            return null != mState ? mState.getItemCount() : 0;
        }
...
//        if (TRACE) TraceHelper.endSection();
    ...
    public void onLayoutChildren(Recycler recycler, State state) {
        ...
        if (mFocusPosition != NO_POSITION && scrollToFocus
            ...
            // FI: we should get the remaining scroll animation offset from RecyclerView
...
//        if (TRACE) TraceHelper.endSection();
    ...
    void startPositionSmoothScroller(int position) {
        LinearSmoothScroller linearSmoothScroller = new GridLinearSmoothScroller() {
            ...
            public PointF computeScrollVectorForPosition(int targetPosition) {
                ...
                // TO We should be able to deduce direction from bounds of current and target
    ...
    private int getPrimarySystemScrollPosition(View view) {
        ...
        // TO: change to use State object in onRequestChildFocus()
        boolean isMin, isMax;
        if (!mReverseFlowPrimary) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        // save views currently is on screen (TO save cached views)
        for (int i = 0, count = getChildCount(); i < count; i++) {
