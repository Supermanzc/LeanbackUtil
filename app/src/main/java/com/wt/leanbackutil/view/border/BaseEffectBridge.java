...
public abstract class BaseEffectBridge {
     ...
     * @param scaleY
     */
    public abstract void onFocusScaleView(View focusView, float scaleX, float scaleY);
     ...
     * @param scaleY
     */
    public abstract void runTranslateAnimation(View focusView, float scaleX, float scaleY);
