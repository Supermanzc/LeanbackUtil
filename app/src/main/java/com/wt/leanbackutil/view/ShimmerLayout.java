...
public class ShimmerLayout extends FrameLayout {
    ...
    private int shimmerRepeatCount = ObjectAnimator.INFINITE;
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            shimmerAngle = a.getInteger(R.styleable.ShimmerLayout_shimmerAngle, DEFAULT_ANGLE);
            shimmerAnimationDuration = a.getInteger(R.styleable.ShimmerLayout_shimmerDuration, DEFAULT_ANIMATION_DURATION);
            shimmerRepeatCount = a.getInteger(R.styleable.ShimmerLayout_shimmerRepeatCount, ObjectAnimator.INFINITE);
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmerColor, getColor(R.color.shimmer_color));
            autoStart = a.getBoolean(R.styleable.ShimmerLayout_shimmerAutoStart, false);
            maskWidth = a.getFloat(R.styleable.ShimmerLayout_shimmerMaskWidth, 0.5F);
            gradientCenterColorWidth = a.getFloat(R.styleable.ShimmerLayout_shimmerGradientCenterColorWidth, 0.1F);
            isAnimationReversed = a.getBoolean(R.styleable.ShimmerLayout_shimmerReverseAnimation, false);
        } finally {
            a.recycle();
        }
    ...
    private Animator getShimmerAnimation() {
        ...
        maskAnimator.setRepeatCount(shimmerRepeatCount);
